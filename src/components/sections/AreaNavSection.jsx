...
export default function AreaNavSection() {
  ...
  if (loading) {
    return (
      <section className="pt-0 pb-20 md:py-28 bg-white">
  ...
  return (
    <section className="pt-6 pb-20 md:py-28 bg-white">
      <div className="container-main">
        {/* Header */}
        <motion.div
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl text-center font-bold text-charcoal tracking-tight mb-3">
            Popular neighbourhoods
          </h2>
          <p className="text-gray-500 max-w-md text-center mx-auto">
